...
{
    local
    Sig := "String_CiNe(Args*)"
    _Validate_Args(Sig, Args)
    return Args.Count() < 2 ? true
         : not String_CiEq(Args*)
}
